...
namespace Service.Repository.news
{
    public class newRepository : DBRepositoryBase, InewRepository
    {
        ...
        //  public IEnumerable<statusresponse> GetStatusResponse(int User_Id)
        // {
        //     var newList2 = new List<statusresponse>();
        //     SqlCommand command = base.CreateCommand("usp_GetStatusResponse", CommandType.StoredProcedure) as SqlCommand;
        //     if (command != null)
        //     {
        ...
        //                 while (reader.Read())
        //                 {
        //                     newList2.Add(new statusresponse
        //                     {
        //                         User_Id = !reader.IsDBNull("User_Id") ? reader.GetInt32("User_Id") : 0,
        //                         Status = !reader.IsDBNull("Status") ? reader.GetString("Status") : "",
        //                         Response = !reader.IsDBNull("Response") ? reader.GetString("Response") : "",
